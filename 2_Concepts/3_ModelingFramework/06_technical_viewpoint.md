...
- **WFR-T5: A logical sub-component of a logical component that was tagged as software must not be traced to any other element than a software element.**
  ...
  - *Reason*: As soon as a logical component is indicated as (pure) software with internal software sub-components, it can only be related to a software execution subsystem in the technical view and this means that its sub-components can only be software elements.
